...
bib <- ReadBib(
  here("Presentacion_git","bibliografia.bib"),
  check = FALSE,
  .Encoding = "UTF-8"
)
...
- #### <font color = #000000> Push: Envía tus cambios (Commits) a un repositorio remoto como GitHub.com. <font> 
